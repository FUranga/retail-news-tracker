...
| Other trade bodies (Usdaw, IGD, Local Data Company, Springboard) + HSE, The Pensions Regulator | ✅ Live (2026-08-30) — gov_config.json, priority: medium. **Trade bodies (BRC, Which?, Usdaw, IGD, LDC, Springboard) fixed 2026-08-31 to their own "Industry" dashboard stream** — they were showing up mislabelled as "Government" |
